...
public class Form {
    public boolean form1(HttpServletRequest request){
        try{    
                ...
                for (int num=1; num<=totalMembers; num++){
                    ...
                    if(num==1) {
                        String HTH_SNO = new Insert().goAutoIncrement("HUD_TENANT_HOUSEHOLD", tc);
    ...
    public boolean form2(HttpServletRequest request){
        try{
                ...
                String HPTBD_SNO_HOUSEHOLD = new Insert().goAutoIncrement("HUD_PHA_TENANT_BLD_DTLS", tc2);
                ...
                String HPAC_ACTION_SNO = new Insert().goAutoIncrement("HUD_PHA_ACTION_CODE", tc3);
    ...
    public boolean form4(HttpServletRequest request){
        try{
                ...
                String HTA_SNO=new Insert().goAutoIncrement("HUD_TENANT_ASSET", tc);
                int num=1;
                while (true){
