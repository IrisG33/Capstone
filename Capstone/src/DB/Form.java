...
public class Form {
    ...
    public boolean form2(HttpServletRequest request){
        try{
                ...
                tc4.add(new TableColumns("String", request.getParameter("HTPA_EFFECTIVE_DATE")));
                ...
                tc4.add(new TableColumns("String", request.getParameter("HTPA_ADMISSION_DATE")));
                tc4.add(new TableColumns("String", request.getParameter("HTPA_PROJEFFECTIVE_DATE_REEXAM")));
                tc4.add(new TableColumns("String", request.getParameter("HTPA_PROJ_DATE_FLATRATE_UPDATE")));
